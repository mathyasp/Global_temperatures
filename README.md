...
## Conclusion
My analysis revealed that there has been a clear increase in average Global temperatures from 1900 to 2013. When considering the average of all of the Countries that I selected as well as all of the Cities, there is also a clear increase in average temperatures from 1900 to 2013. When looking at the Countries' averages, there is still an increase in temperature, however, less distinct. What is also interesting is that four of the Countries actually show a reduction in temperature when looking at the difference from 2013 and 1900, though they are still trending up. It may be the case that 2013 was an outlier year and caused this discrepency. To confirm, this analysis would have to be repeated in the future to see where the trends go. 
